...
from helpers import animations, bitmaputils, textutils
...
class Particles(Drawer):
    ...
    def apply(self, frame, delta, progression, beat):
        ...
        color = self.color.get_value(delta, progression, beat)
        self.coords = [self.path[int((pos +
                                      i /
                                      self.particles) *
                                     len(self.path)) %
                                 len(self.path)] for i in range(self.particles)]
        return super().apply(frame, delta, progression, beat)
...
class Milkdrop(core.Application):
    ...
    def __init__(self, *args, **kwargs):
        ...
        circle_big = [(3, 3), (4, 3), (5, 3), (6, 3), (7, 4), (8, 5), (9, 6), (9, 7), (9, 8), (9, 9), (8, 10), (7, 11),
                      (6, 12), (5, 12), (4, 12), (3, 12), (2, 11), (1, 10), (0, 9), (0, 8), (0, 7), (0, 6), (1, 5), (2, 4)]
        ...
        self.visualizations = [
            ...
            Visualization(name="FASNACHT",
                          ...
                          effects=[
                              ...
                              TextDrawer(text="FASNACHT", loc=(2, 5), driver=AnimatedValue(fun2=lambda x:x, period=8), color=AnimatedHSVColor(h=ConstantValue(0.66))),
    ...
    def update(self, io, delta):
        ...
        if io.controller.a.get_fresh_value():
            ...
            if self.last_beats[0] + self.beat_duration < now:
                self.beat = True
                self.last_beats = [self.last_beats[0] + self.beat_duration] + \
