...
def cut(img_w, img_h, disp_w, disp_h, x, y):
    ...
    return (img_left, img_top, img_right, img_bottom), (dsp_left, dsp_top, dsp_right, dsp_bottom)
...
def apply_bitmap(bmp, display, loc, bg_color=None, fg_color=(255, 255, 255)):
    ...
    (bmp_left, bmp_top, bmp_right, bmp_bottom), (dsp_left, dsp_top, dsp_right, dsp_bottom) = cut(w, h, display.width, display.height, x, y)
...
def apply_image(img, display, loc):
    ...
    (img_left, img_top, img_right, img_bottom), (dsp_left, dsp_top, dsp_right, dsp_bottom) = cut(w, h, display.width, display.height, x, y)
